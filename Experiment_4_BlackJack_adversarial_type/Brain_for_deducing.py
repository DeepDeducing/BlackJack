...
class Brain(object):
    ...
    def generate_values_for_each_layer(self, input):
        ...
        binomial                  = np.atleast_2d(np.random.binomial(1, 1 - 0.2, size=40))

        input[:,201:]             = input[:,201:] * binomial
    ...
    def train_for_input_value(self,
        ...
        self.known_and_unkown_input_value         += layer_delta  * self.beta    * self.known_and_unkown_input_value_resistor + 0.9 * self.known_and_unkown_input_value_momentum * self.known_and_unkown_input_value_resistor
        self.known_and_unkown_input_value_momentum = layer_delta  * self.beta    * self.known_and_unkown_input_value_resistor + 0.9 * self.known_and_unkown_input_value_momentum * self.known_and_unkown_input_value_resistor


    def deduce_batch(self, known_and_unkown_input_value, known_and_unkown_input_value_momentum, known_and_unkown_input_value_resistor, corresponding_output, weight_list, slope_list):
        ...
        self.known_and_unkown_input_value_momentum = known_and_unkown_input_value_momentum
        ...
        return self.known_and_unkown_input_value, self.known_and_unkown_input_value_momentum
